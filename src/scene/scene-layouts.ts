...
export const LAYOUTS: Record<string, SceneLayout> = {
  portrait1: {
    ...
    joystick:   { position: [-2.0, -2.5, 0],   rotation: [0, 0, 0],    scale: [0.5, 0.5, 0.5], visible: true },
    fireButton: { position: [2.0, -2.5, 0],    rotation: [0, 0, 0],    scale: [0.5, 0.5, 0.5], visible: true },
    menuButton: { position: [0, -2.5, 0],      rotation: [0, 0, 0],    scale: [0.5, 0.5, 0.5], visible: true },
  ...
  landscape: {
    ...
    joystick:   { position: [-3.5, -1.8, 0],   rotation: [0, 0, 0],    scale: [0.6, 0.6, 0.6], visible: true },
    fireButton: { position: [3.5, -1.8, 0],    rotation: [0, 0, 0],    scale: [0.6, 0.6, 0.6], visible: true },
    menuButton: { position: [3.5, 2.0, 0],     rotation: [0, 0, 0],    scale: [0.5, 0.5, 0.5], visible: true },
    menuCodex:  { position: [0, 0, -8],        rotation: [0, 0, 0],    scale: [1, 1, 1], visible: false },
  ...
  menuPortrait: {
    ...
    joystick:   { position: [-2.0, -2.5, -4],  rotation: [0, 0, 0],    scale: [0.35, 0.35, 0.35], visible: true },
    fireButton: { position: [2.0, -2.5, -4],   rotation: [0, 0, 0],    scale: [0.35, 0.35, 0.35], visible: true },
    menuButton: { position: [0, -2.5, -4],     rotation: [0, 0, 0],    scale: [0.35, 0.35, 0.35], visible: true },
  ...
  menuLandscape: {
    ...
    joystick:   { position: [-3.5, -1.8, -4],  rotation: [0, 0, 0],    scale: [0.4, 0.4, 0.4], visible: true },
    fireButton: { position: [3.5, -1.8, -4],   rotation: [0, 0, 0],    scale: [0.4, 0.4, 0.4], visible: true },
    menuButton: { position: [3.5, 2.0, -4],    rotation: [0, 0, 0],    scale: [0.35, 0.35, 0.35], visible: true },
