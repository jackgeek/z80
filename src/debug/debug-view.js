...
// ============================================================
// Visualises the Z80's full 64 KB address space (0x0000–0xFFFF)
// as a 256×256 pixel grayscale image.  Each pixel = one byte:
...
let _dbgCanvas = null;
let _dbgCtx = null;
let _dbgImageData = null;
let _dbgImgBuf = null;
let _dbgMemView = null;
let _dbgGfxReady = false;

// References from main.js
let _dbgMemory = null;
let _dbgWasm = null;
let _dbgIsPaused = null;
let _dbgRenderFrame = null;
let _dbgInitialized = false;
let _dbgSelectedAddr = -1;

// DOM
let _dbgElAddr, _dbgElValue, _dbgElRegion, _dbgElEdit;

// ── Lazy graphics setup (deferred until canvas is visible) ──
function dbgEnsureGfx() {
